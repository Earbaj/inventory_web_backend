...
__decorate([
    (0, mongoose_1.Prop)({ default: 'General', trim: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ required: true, default: 0 }),
    __metadata("design:type", Number)
], Item.prototype, "stockQuantity", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: 'pcs', trim: true }),
    __metadata("design:type", String)
], Item.prototype, "unit", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, default: 5 }),
    __metadata("design:type", Number)
], Item.prototype, "lowStockThreshold", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, type: String, index: true }),
    __metadata("design:type", String)
], Item.prototype, "shopId", void 0);
__decorate([
